    ...
    <div>
      <section className="bg-[#faebdd] py-16 px-4 relative overflow-hidden">
        <div className="flex flex-col lg:flex-row justify-center items-center gap-10 max-w-6xl mx-auto">
          ...
          {/* Center Image */}
          <div
            style={{ backgroundImage: `url(${moddlefood.src})` }}
            className="bg-cover   p-2 rounded-full border-4 border-white  shadow-lg"
          >
            <div className="overflow-hidden border-2 rounded-full w-[280px] h-[360px]"></div>
          </div>
        ...
        <div className="relative  py-20">
          ...
          <div className="relative z-10 flex flex-col items-center text-center max-w-2xl mx-auto px-4">
            ...
            <p className="italic text-sm text-orange-800 mb-2">
            ...
            <p className="text-gray-700 text-sm mb-6 max-w-lg">
              Whether you're feeling peckish or hungry, whether it's midday or
              midnight, our menu has something to satisfy every appetite.
