  ...
  return (
    <div className="banner-wrapper">
      ...
      >
        ...
        <Container>
          <div className="md:mx-10 absolute left-0 right-0 bottom-20 sm:bottom-28 md:bottom-36 z-20">
            <div className="flex items-center justify-between">
              {/* Social Icons */}
              <div className="text-sm md:text-base text-white flex items-center gap-1.5 sm:gap-3 md:gap-5 font-medium">
                <p className="whitespace-nowrap">Follow Our Socials</p>
                <div className="bg-white/10 p-1 sm:p-1.5 md:p-2 rounded-full">
